...
\begin{abstract}
	We describe a software defined networking based architecture for core transport networks. 
	In this paper, we demonstrate a prototype virtual switch managing optical transport network 
	elements. With appropriate extensions to OpenFlow, we believe that the programmability and flexibility SDN
